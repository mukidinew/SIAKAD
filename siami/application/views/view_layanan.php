<section class="content-header">
  ...
  <ol class="breadcrumb">
	<li><i class="fa fa-credit-card"></i> <a href="#">Transaksi</a></li>
								...
								if(!empty($src) && isset($src)){
									if($jml > 0){
										foreach($datamahasiswa as $dm){
											...
											echo "<td>".$dm->email."</td>";
											echo "<td class='text-center'><a href='".base_url("transaksi/p/".base64_encode($dm->nim))."' class='btn btn-xs btn-flat btn-danger'><i class='fa fa-gear'></i> Proses Transaksi</a></td>";
											echo "</tr>";
										}
									}
									else{
...
<script type="text/javascript">
	...
	if(e.keyCode == 13 && obj.value != ""){
		...
		window.location = "<?php echo base_url("transaksi/layanan"); ?>?cari="+obj.value;
	}
}
</script>
