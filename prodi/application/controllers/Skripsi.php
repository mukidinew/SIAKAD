...
class Skripsi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('skripsi/tb_skripsi_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'tgl_daftar' => $row->tgl_daftar,
            ...
            $this->load->view('skripsi/tb_skripsi_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->load->view('skripsi/tb_skripsi_form', $data);
    }
...
/* Location: ./application/controllers/Skripsi.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2016-09-23 17:51:19 */
/* http://harviacode.com */