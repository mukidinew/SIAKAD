...
class Dosen_penguji extends CI_Controller
{
    ...
    public function get_penguji($id_maju,$nim)
    {
      ...
      if ($dosen_penguji==null) {
        $data = array(
            ...
            'id_dosen_1' => set_value('id_dosen_1'),
      	    'id_dosen_2' => set_value('id_dosen_2')
      	);
...
/* End of file Dosen_penguji.php */
/* Location: ./application/controllers/Dosen_penguji.php */
