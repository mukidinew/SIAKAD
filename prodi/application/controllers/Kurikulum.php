...
class Kurikulum extends CI_Controller
{
    ...
    {
        $kurikulum = $this->Kurikulum_model->get_all($this->session->userdata('level_prodi'));
        $mata_kuliah_kurikulum = $this->app_model->get_all_view_mk_kur($this->session->userdata('level_prodi'));
        $data = array(
    ...
    public function getProdi(){
      ...
      if ($page=='') {
        $prodi = $this->app_model->get_query("SELECT * FROM tb_prodi WHERE id_prodi='". $this->session->userdata('level_prodi') ."'")->result();
      }
      else {
    ...
    {
      $mk_kur = $this->Kurikulum_model->get_query("SELECT * FROM v_mk_kurikulum WHERE id_kurikulum='".$id_kur."' AND kd_prodi='". $this->session->userdata('level_prodi') ."'")->result();
    ...
    public function duplikasi_matkul()
    {
      ...
      $mk_kur = $this->Kurikulum_model->get_query("SELECT * FROM v_mk_kurikulum WHERE id_kurikulum='".$id_kurikulum."' AND kd_prodi='". $this->session->userdata('level_prodi') ."'");
