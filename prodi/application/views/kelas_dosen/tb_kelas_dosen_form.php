      ...
      <form action="<?php echo $action; ?>" method="post">
        <div class="col-md-12">
          ...
          ?>
            <div class="form-group">
              <label for="int">Kelas Kuliah <?php echo form_error('id_kelas_kuliah') ?></label>
              <input type="text" class="form-control" name="id_kelas_kuliah" id="id_kelas_kuliah_update" value="<?php echo $id_kelas_kuliah_update; ?>" />
            </div>
            <div class="form-group">
              <label for="int">NIDN <?php echo form_error('id_dosen') ?></label>
              <input type="text" class="form-control" name="id_dosen" id="id_dosen_update" value="<?php echo $id_dosen_update; ?>"  />
            </div>
          <?php
          }
          ?>
