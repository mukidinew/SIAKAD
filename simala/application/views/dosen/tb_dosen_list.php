<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      <?php echo anchor(site_url('dosen/create'), 'Create', 'class="btn btn-primary btn-block"'); ?>
      <?php echo anchor(site_url('dosen/excel'), 'Excel', 'class="btn btn-primary btn-block"'); ?>
      <?php echo anchor(site_url('dosen/word'), 'Word', 'class="btn btn-primary btn-block"'); ?>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12">
